...
const TransactionToBeConfirmedPool2 = (data) => {
  ...
  return (
          <>
            ...
            <div className='confirmed_info'>
              <p>{data.data.name + ' Pool 2 to: ' + data.data.destination}</p>
            </div>
            ...
            <>
            <div className='confirmed_info'>
              <p>{data.data.name + ' '  + ethers.utils.formatEther(data.data.value, 18) + ' RDS to Pool 2 : ' + data.data.destination}</p>
            </div>
            <div className='confirmed_button_container'>
              <button className="confirmed_button" onClick={() => data.confirmTransactionPool2(data.data.id)}>
                Confirm
            ...
            <>
            <div className='confirmed_info'>
              <p>{'Pool 2 ' + data.data.name + ' ' + ethers.utils.formatEther(data.data.value, 18) + ' (' + data.data.addr + ')' + ' to: ' + data.data.destination}</p>
            </div>
            <div className='confirmed_button_container'>
              <button className="confirmed_button" onClick={() => data.confirmTransactionPool2(data.data.id)}>
                Confirm
            ...
            <>
            <div className='confirmed_info'>
              <p>{'Pool 2 ' + data.data.name + ' to: ' + data.data.destination}</p>
            </div>
            <div className='confirmed_button_container'>
              <button className="confirmed_button" onClick={() => data.confirmTransactionPool2(data.data.id)}>
                Confirm
...
export default TransactionToBeConfirmedPool2
