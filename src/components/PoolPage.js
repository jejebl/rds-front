      ...
      <div className='poolpage'>
        ...
        <div className='poolpage_description'>
          ...
          <div className='poolpage_info_container'>
            ...
            <div className='poolpage_description_line'>
              <p className='poolpage_info_title'>My DFL</p>
        ...
        <div className='poolpage_name_text'>
          <p>Staking: When you deposit your DFL tokens into the pool, they are staked to generate yield from real-world assets. This staking mechanism is designed to encourage long-term participation, ensuring the stability and longevity of the pool.</p>
          ...
          <br></br>
          <p>Weekly Rewards: Every 2 weeks, DFL distributes rewards to its stakers. These rewards are paid in DFL tokens and are derived from the yield generated by the underlying Real-World Assets. This consistent payout ensures that stakers receive regular returns for their commitment, further enhancing the benefits of being part of the DFL ecosystem.</p>
        </div>
        : PoolNb==='Pool 2' ? 
        <div className='poolpage_name_text'>
          <p>Staking: When you deposit your DFL tokens into the pool, they are staked to generate yield from real-world assets. This staking mechanism is designed to encourage long-term participation, ensuring the stability and longevity of the pool.</p>
        ...
        <div className='poolpage_allocation_1_container'>
          <div className='poolpage_allocation_token'>
            ...
            */}
            <p className='poolpage_allocation_name'>RWA</p>
          </div>
          <div>
            <p>Allocations</p>
            <p>100%</p>
